...
public class NumberleGameTest {
    ...
    public void testInitialize() throws Exception{
        ...
        assertEquals("Initial remaining attempts should be MAX_ATTEMPTS", model.getMaxGuess(), model.getRemainingAttempts());
    ...
    public void testGameProcess() throws FileNotFoundException {
        ...
        assertEquals("Initial remaining attempts should reduce 1 after input", model.getMaxGuess() - 1, model.getRemainingAttempts());
        for (int i = 0; i < model.getMaxGuess() - 1; i++) {
            model.processInput(wrongEquation);
        }
    ...
    public void testInputValid() throws FileNotFoundException {
        ...
        assertEquals("Initial remaining attempts should not change with invalid length", model.getMaxGuess(), model.getRemainingAttempts());
        ...
        assertEquals("Initial remaining attempts should not change with other symbol (not number or '+-*/) input", model.getMaxGuess(), model.getRemainingAttempts());
        ...
        assertEquals("Initial remaining attempts should not change with an equation with invalid format", model.getMaxGuess(), model.getRemainingAttempts());
        ...
        assertEquals("Initial remaining attempts should not change with an equation with wrong equation in math area.", model.getMaxGuess(), model.getRemainingAttempts());
        ...
        assertEquals("Initial remaining attempts should reduce 1 after valid input", model.getMaxGuess() - 1, model.getRemainingAttempts());
